...
**🚀 [Live Demo](https://nft-floor-tracker.vercel.app)**

Real-time NFT analytics platform monitoring floor prices across OpenSea, Blur, Magic Eden, and LooksRare. Features historical charts, volume analytics, rarity rankings, and whale tracking.
...
git clone https://github.com/nasrulniroi/nft-floor-tracker.git
...
# Set up database
psql -c "CREATE DATABASE nft_floor_tracker"
psql nft_floor_tracker < database/001_initial.sql
...
```env
DATABASE_URL=postgresql://user:pass@localhost:5432/nft_floor_tracker
